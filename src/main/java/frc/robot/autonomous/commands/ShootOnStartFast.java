...
public class ShootOnStartFast extends CommandBase {
    ...
    public ShootOnStartFast (ShooterSubsystem shooterSubsystem, IndexerSubsystem indexerSubsytem, IntakeSubsystem intakeSubsystem, double targetRpm) {
