...
public class Shoot5 extends CommandBase {
    ...
    public Shoot5 (ShooterSubsystem shooterSubsystem, IndexerSubsystem indexerSubsytem, IntakeSubsystem intakeSubsystem, double targetRpm) {
